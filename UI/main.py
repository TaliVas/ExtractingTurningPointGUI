...
class App:
    ...
    def start_movement_and_turning_point_predictions(self, start_model, turn_model)->pd.DataFrame:
        ...
        turn_model = 'stop_turn_model.pth'
        turn_df_predicted = predict_and_plot_turn(df_test_features, turn_model, turn_features, self.__turn_pth)
...
#turn_model_path = f'C:\Users\avita\source\repos\ofekm5\ExtractingTurningPointGUI\UI\utils\{turn_model}'
def main():
    app = App()
